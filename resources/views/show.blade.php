        ...
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            ...
            <div class="md:ml-24">
                ...
                <div class="mt-12">
                    ...
                    <div class="flex mt-4">
                        @foreach(array_slice($movie['credits']['crew'], 0, 4)  as $crew)
                            @if(!$loop->index < 2)
                                <div>
                                    <div>{{ $crew['name']}}</div>
                    ...
                    @if ($movie['videos']['results'] > 0)
                        <div class="mt-12">
                            <a href="https://youtube.com/watch?v={{ $movie['videos']['results']['0']['key'] }}" class="flex inline-flex items-center bg-yellow-500 text-gray-600 font-semibold px-5 py-4 hover:bg-yellow-400 transition ease-in-out duration-150">
